...
<main id="main" class="main h-100">
    ...
    <div class="pagetitle">
      <h1>Add List Data Peserta</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.html">Home</a></li>
          <li class="breadcrumb-item active">List Data Peserta / Add</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                    <h5 class="card-title">Welcome Admin <span>| Add List Data Peserta</span></h5>
                    <div>
                        <form>
                            <div class="mb-3">
