...
<main id="main" class="main h-100">
    ...
    <div class="pagetitle">
      <h1>Tambah Perusahaan List Info Lowongan</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.html">Home</a></li>
          <li class="breadcrumb-item active">List Info Lowongan / Tambah Perusahaan</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="row">
              ...
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body">
                      <h5 class="card-title">Welcome Admin <span>| Tambah Perusahaan List Info Lowongan</span></h5>
                      <div>
                        <form>
                            <div class="mb-3">
