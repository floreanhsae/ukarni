...
<body class="vh-100">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="components-alerts.html">
              <i class="bi bi-circle"></i><span>List Page</span>
            </a>
          </li>
          <li>
          ...
          <li>
            <a href="components-badges.html">
              <i class="bi bi-circle"></i><span>Edit Page</span>
            </a>
          </li>
        </ul>
      </li> -->
      ...
      <!-- <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-layout-text-window-reverse"></i><span>Info Lowongan</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="tables-general.html">
              <i class="bi bi-circle"></i><span>List Info Lowongan</span>
            </a>
          </li>
          <li>
            <a href="tables-data.html">
              <i class="bi bi-circle"></i><span>Add Lowongan</span>
            </a>
          </li>
          <li>
            <a href="tables-general.html">
              <i class="bi bi-circle"></i><span>Edit Lowongan</span>
            </a>
          </li>
          <li>
            <a href="tables-data.html">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="../public/views/page.blade.php">
          ...
          <div class="row"> -->
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Welcome Admin <span>| Jumlah Page View Website</span></h5>
  ...
  <footer id="footer" class="footer fixed-bottom">
    <div class="copyright">
      &copy; Copyright <strong><span>2022</span></strong> Politeknik Elektronika Negeri Surabaya
    </div>
    <!-- <div class="credits">
